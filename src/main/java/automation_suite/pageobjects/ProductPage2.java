...
public class ProductPage2 extends BaseClass {
	...
	public void SizeSelect(String Size) {
		...
		public void ColorClass(String color) throws InterruptedException {
		//for Colour
		driver.findElement(
				By.cssSelector("div[class='swatch-attribute color'] div div[aria-label='" + color + "']"))
				.click();
		AddToCart.click();
